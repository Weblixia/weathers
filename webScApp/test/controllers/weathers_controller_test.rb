...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { address: @weather.address, gaiyo: @weather.gaiyo, kion: @weather.kion, kosui: @weather.kosui, max: @weather.max, min: @weather.min, nichiji: @weather.nichiji, tenki: @weather.tenki } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { address: @weather.address, gaiyo: @weather.gaiyo, kion: @weather.kion, kosui: @weather.kosui, max: @weather.max, min: @weather.min, nichiji: @weather.nichiji, tenki: @weather.tenki } }
